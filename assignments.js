...
// console.log(`The ${myCountry.country} has ${myCountry.population} ${myCountry.language} speaking people, ${myCountry.neighbors.length} neighboring countries and a capital city called ${myCountry.capital}.`);
...
//         return `The ${this.country} has ${this.population} people that speak ${this.language}. The ${this.country} has ${this.neighbors.length} neighboring countries and has a capital city called ${this.capital}
//     The ${this.country} is also ${this.isIsland ? 'an' : 'not an'} island.`
//     },
//     isIsland: false
// };
